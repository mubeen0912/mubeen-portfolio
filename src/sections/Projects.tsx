...
const projects = [
  ...
  {
    number: '03',
    title: 'Event-Driven Serverless AWS Cost Optimization',
    description:
      'Created scheduled AWS automation to identify and delete stale EBS snapshots and send execution summaries through SNS.',
    highlights: [
      'Automated stale EBS snapshot cleanup with Lambda and Boto3',
      'Scheduled execution using Amazon EventBridge',
      'Added CloudWatch logging and SNS email notifications',
    ],
    workflow: ['EventBridge', 'Lambda', 'EBS', 'SNS'],
  ...
  },
  {
    ...
    description:
      'Created reusable Infrastructure as Code templates for repeatable AWS networking and compute environment provisioning.',
    highlights: [
      'Provisioned VPC and public subnet infrastructure',
      'Automated EC2 and Security Group creation',
      'Configured routing and Internet Gateway resources',
    ],
    workflow: ['Template', 'CloudFormation', 'VPC', 'EC2'],
